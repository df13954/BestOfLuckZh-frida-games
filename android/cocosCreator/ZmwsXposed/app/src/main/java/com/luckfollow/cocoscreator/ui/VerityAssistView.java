package com.luckfollow.cocoscreator.ui;
...
import com.luckfollow.cocoscreator.version.ScriptVersion;
...
public class VerityAssistView {
    ...
    public boolean assertSignature(Application application, VersionEntity versionEntity) {
